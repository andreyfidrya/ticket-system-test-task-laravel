...
<html class="landing simple-sticky-header-enabled">
	<head>
		...
		<title>Ticket System Test Task Laravel</title>
					...
					<div class="container pt-5 mt-lg-5">
						<div class="row align-items-center pt-3">
							<div class="col-lg-5 mb-5">
								...
								<h1 class="font-weight-bold text-color-light text-13 line-height-2 mt-0 mb-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="400" data-appear-animation-duration="750">Ticket System Test Task Laravel<span class="appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="600" data-appear-animation-duration="800"><span class="d-inline-block text-primary highlighted-word highlighted-word-rotate highlighted-word-animation-1 alternative-font-3 font-weight-bold text-1 ms-2">ever</span></span></h1>
								<p class="custom-font-size-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="900" data-appear-animation-duration="750">Ticket System Test Task Laravel - мини-CRM для сбора и обработки заявок с сайта через универсальный виджет. Система позволяет менеджерам просматривать список заявок, фильтровать заявки по дате, статусу, email, телефону. Можно также просматривать детали заявки и менять статусы заявок.</p>
